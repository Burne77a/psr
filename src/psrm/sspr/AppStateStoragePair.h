...
class AppStateStoragePair: public ISerializable
{
  ...
  public: 
    ...
    AppStateStoragePair(const unsigned int appId, const unsigned int storageId, std::string_view stateStorageIpAddr);
    ...
    void SetStorage(const unsigned int storageId, std::string_view storageIpAddr);
