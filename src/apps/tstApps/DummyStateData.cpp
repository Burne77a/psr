...
{
  LogMsg(LogPrioInfo,"DummyStateData: Size: %u, postPater: %s serializedSize: %d payloadSize: %d", m_data.payloadSize,m_data.postPattern,m_serializedData.size(),m_payload.size());
}
